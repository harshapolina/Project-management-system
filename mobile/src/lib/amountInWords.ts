/**
 * Indian rupees → words, for GST tax invoices.
 * Ported 1:1 from client/src/lib/amountInWords.js so both clients print the
 * same "Amount Chargeable (in words)" line for a given total.
 */
...
/** e.g. "Indian Rupees Ten Lakh … and Sixty Two paise Only" */
