...
export const PROCUREMENT_TABS: ProcurementTabMeta[] = [
  ...
  { key: 'rfqs', label: 'RFQs', icon: 'send-outline' },
  { key: 'pos', label: 'Purchase orders', icon: 'cube-outline' },
  { key: 'grn', label: 'GRN', icon: 'download-outline' },
  { key: 'qc', label: 'QC', icon: 'checkmark-done-outline' },
  { key: 'debit', label: 'Debit notes', icon: 'alert-circle-outline' },
  { key: 'inventory', label: 'Inventory', icon: 'file-tray-stacked-outline' },
